(function() {
  ...
  if (DEBUG) {
    console.log('%c🟠 MySellKit TEST Mode', 'background: #f97316; color: white; padding: 8px 16px; border-radius: 4px; font-size: 14px; font-weight: bold;');
  }
  
  const CONFIG = {
    API_BASE: 'https://app.mysellkit.com/version-test/api/1.1/wf',
    STRIPE_KEY: 'pk_test_51SC1AFBIipXO39gRV67hQNmil97MFHRfiW3y2RaaLH1EjPmcKVxuShDvThYysr5GpWROQxfdJT2EsARFU6aQ3fSv00W0KZXkvy',
    ...
    SETTINGS_URL_BASE: 'https://app.mysellkit.com/version-test/?v=settings&product='
  };
